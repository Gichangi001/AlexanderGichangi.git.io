$(document).ready(function(){
    ...
    var typed = new Typed(".typing", {
        strings: ["Solutions Architect", "IT Consultant", "IT Manager", "Cloud Expert", "Tech Leader","EXPERT"],
        typeSpeed: 100,
        backSpeed: 60,
        loop: true
    });
    ...
    var typed = new Typed(".typing-2", {
        strings: ["Solutions Architect", "IT Consultant", "IT Manager", "Cloud Expert", "Tech Leader", "Business Consultant"],
        typeSpeed: 100,
        backSpeed: 60,
        loop: true
    });
